...
var _mozilla$delivery_dashboard$Types$Model = F2(
	function (a, b) {
		return {holidays: a, year: b};
	});
var _mozilla$delivery_dashboard$Types$Holiday = F3(
	function (a, b, c) {
		return {date: a, title: b, countries: c};
	});
var _mozilla$delivery_dashboard$Types$HolidaysFetched = function (a) {
	return {ctor: 'HolidaysFetched', _0: a};
};
var _mozilla$delivery_dashboard$Types$SetDate = function (a) {
	return {ctor: 'SetDate', _0: a};
};

var _mozilla$delivery_dashboard$Decoder$decodeDate = A2(
	_elm_lang$core$Json_Decode$andThen,
	function (value) {
		...
		var _p0 = {
			ctor: '_Tuple3',
			_0: A2(_elm_lang$core$Array$get, 0, parts),
			_1: A2(_elm_lang$core$Array$get, 1, parts),
			_2: A2(_elm_lang$core$Array$get, 2, parts)
		};
		if ((((_p0.ctor === '_Tuple3') && (_p0._0.ctor === 'Just')) && (_p0._1.ctor === 'Just')) && (_p0._2.ctor === 'Just')) {
			var _p1 = {
				ctor: '_Tuple3',
				_0: _elm_lang$core$String$toInt(_p0._0._0),
				_1: _elm_lang$core$String$toInt(_p0._1._0),
				_2: _elm_lang$core$String$toInt(_p0._2._0)
			};
			if ((((_p1.ctor === '_Tuple3') && (_p1._0.ctor === 'Ok')) && (_p1._1.ctor === 'Ok')) && (_p1._2.ctor === 'Ok')) {
				return _elm_lang$core$Json_Decode$succeed(
					A3(_elm_community$elm_time$Time_Date$date, _p1._0._0, _p1._1._0, _p1._2._0));
			} else {
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown date: ', value));
			}
		} else {
			return _elm_lang$core$Json_Decode$fail(
				A2(_elm_lang$core$Basics_ops['++'], 'Unknown date: ', value));
...
var _mozilla$delivery_dashboard$Decoder$holidayDecoder = A3(
	...
	A3(
		...
		A3(
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
			'date',
			_mozilla$delivery_dashboard$Decoder$decodeDate,
			_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_mozilla$delivery_dashboard$Types$Holiday))));
var _mozilla$delivery_dashboard$Decoder$holidaysDecoder = A4(
	...
	A3(
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
		'holidays',
		_elm_lang$core$Json_Decode$list(_mozilla$delivery_dashboard$Decoder$holidayDecoder),
		_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_mozilla$delivery_dashboard$Types$Model)));

var _mozilla$delivery_dashboard$Command$getHolidays = function (year) {
	return A2(
		_lukewestby$elm_http_builder$HttpBuilder$send,
		_mozilla$delivery_dashboard$Types$HolidaysFetched,
		A2(
			_lukewestby$elm_http_builder$HttpBuilder$withExpect,
			_elm_lang$http$Http$expectJson(_mozilla$delivery_dashboard$Decoder$holidaysDecoder),
			A2(
				...
				_lukewestby$elm_http_builder$HttpBuilder$get(
					A2(
						_elm_lang$core$Basics_ops['++'],
						'https://diggory.dev.mozaws.net/v0/holidays/',
						_elm_lang$core$Basics$toString(year))))));
};

var _mozilla$delivery_dashboard$Init$now = A2(
	_elm_lang$core$Task$perform,
	function (_p0) {
		return _mozilla$delivery_dashboard$Types$SetDate(
...
var _mozilla$delivery_dashboard$Init$init = A2(
	...
	{
		holidays: {ctor: '[]'},
		year: _elm_lang$core$Maybe$Nothing
	},
	{
		ctor: '::',
		_0: _mozilla$delivery_dashboard$Init$now,
		_1: {ctor: '[]'}
	});
...
var _mozilla$delivery_dashboard$Update$update = F2(
	function (msg, model) {
		...
		if (_p0.ctor === 'SetDate') {
			var _p1 = _p0._0;
			if (_p1.ctor === 'Just') {
				var year = _elm_lang$core$Date$year(_p1._0);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
					_elm_lang$core$Native_Utils.update(
						model,
						{
							year: _elm_lang$core$Maybe$Just(year)
						}),
					{
						ctor: '::',
						_0: _mozilla$delivery_dashboard$Command$getHolidays(year),
						_1: {ctor: '[]'}
					});
			} else {
				return A2(
			...
			if (_p0._0.ctor === 'Ok') {
				...
				return A2(
					...
					_elm_lang$core$Native_Utils.update(
						model,
						{holidays: _p2.holidays, year: _p2.year}),
					{ctor: '[]'});
			} else {
...
var _mozilla$delivery_dashboard$View$displayDate = function (date) {
	return _elm_lang$core$Basics$toString(
		_elm_community$elm_time$Time_Date$day(date));
};
var _mozilla$delivery_dashboard$View$displayHoliday = function (holiday) {
	return A2(
			...
			_0: A2(
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						_mozilla$delivery_dashboard$View$displayDate(holiday.date)),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
						...
						_elm_lang$html$Html$a,
						{
							...
							_1: {
								...
								_0: _elm_lang$html$Html_Attributes$title(
									A2(_elm_lang$core$String$join, ', ', holiday.countries)),
								_1: {ctor: '[]'}
							}
						},
						{
							ctor: '::',
							_0: _elm_lang$html$Html$text(holiday.title),
							_1: {ctor: '[]'}
						}),
					_1: {ctor: '[]'}
				}
...
var _mozilla$delivery_dashboard$View$filterMonth = F2(
	function (month, holidays) {
		return A2(
			_elm_lang$core$List$filter,
			function (h) {
				return _elm_lang$core$Native_Utils.eq(
					month,
					_elm_community$elm_time$Time_Date$month(h.date));
			},
			holidays);
	});
var _mozilla$delivery_dashboard$View$displayMonth = F3(
	function (name, month, holidays) {
		return A2(
			_elm_lang$html$Html$li,
			{ctor: '[]'},
			{
				...
				_1: {
					...
					_0: A2(
						...
						A2(
							_elm_lang$core$List$map,
							_mozilla$delivery_dashboard$View$displayHoliday,
							A2(_mozilla$delivery_dashboard$View$filterMonth, month, holidays))),
					_1: {ctor: '[]'}
				}
			});
	});
var _mozilla$delivery_dashboard$View$displayHolidaysPerMonth = function (holidays) {
	return {
		ctor: '::',
		_0: A3(_mozilla$delivery_dashboard$View$displayMonth, 'January', 1, holidays),
		_1: {
			ctor: '::',
			_0: A3(_mozilla$delivery_dashboard$View$displayMonth, 'February', 2, holidays),
			_1: {
				ctor: '::',
				_0: A3(_mozilla$delivery_dashboard$View$displayMonth, 'March', 3, holidays),
				_1: {
					ctor: '::',
					_0: A3(_mozilla$delivery_dashboard$View$displayMonth, 'April', 4, holidays),
					_1: {
						ctor: '::',
						_0: A3(_mozilla$delivery_dashboard$View$displayMonth, 'May', 5, holidays),
						_1: {
							ctor: '::',
							_0: A3(_mozilla$delivery_dashboard$View$displayMonth, 'June', 6, holidays),
							_1: {
								ctor: '::',
								_0: A3(_mozilla$delivery_dashboard$View$displayMonth, 'July', 7, holidays),
								_1: {
									ctor: '::',
									_0: A3(_mozilla$delivery_dashboard$View$displayMonth, 'August', 8, holidays),
									_1: {
										ctor: '::',
										_0: A3(_mozilla$delivery_dashboard$View$displayMonth, 'September', 9, holidays),
										_1: {
											ctor: '::',
											_0: A3(_mozilla$delivery_dashboard$View$displayMonth, 'October', 10, holidays),
											_1: {
												ctor: '::',
												_0: A3(_mozilla$delivery_dashboard$View$displayMonth, 'November', 11, holidays),
												_1: {
													ctor: '::',
													_0: A3(_mozilla$delivery_dashboard$View$displayMonth, 'December', 12, holidays),
													_1: {ctor: '[]'}
												}
											}
										}
...
var _mozilla$delivery_dashboard$View$displayHolidays = F2(
					...
					{ctor: '[]'},
					{
						...
						_1: {
							...
							_0: A2(
								_elm_lang$html$Html$ul,
								{ctor: '[]'},
								_mozilla$delivery_dashboard$View$displayHolidaysPerMonth(holidays)),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
					...
					_0: A2(
						...
						},
						{
							...
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html$text('Mozilla Global Public Holidays'),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}),
				...
				},
				{
					...
					_0: function () {
						...
						if (_p0.ctor === 'Nothing') {
							...
							return A2(_mozilla$delivery_dashboard$View$displayHolidays, _p0._0, model.holidays);
						}
					}(),
					_1: {ctor: '[]'}
				}),
...
if (typeof _mozilla$delivery_dashboard$Main$main !== 'undefined') {
    _mozilla$delivery_dashboard$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Time.Date.Date":{"args":[],"tags":{"Date":["{ year : Int, month : Int, day : Int }"]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Date.Date":{"args":[],"tags":{"Date":[]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"Types.Msg":{"args":[],"tags":{"SetDate":["Maybe.Maybe Date.Date"],"HolidaysFetched":["Result.Result Http.Error Types.Model"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Types.Model":{"args":[],"type":"{ holidays : List Types.Holiday, year : Maybe.Maybe Int }"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Types.Holiday":{"args":[],"type":"{ date : Time.Date.Date, title : String, countries : List String }"}},"message":"Types.Msg"},"versions":{"elm":"0.18.0"}});
}
