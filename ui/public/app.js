...
var _mozilla$delivery_dashboard$Types$Model = {};
var _mozilla$delivery_dashboard$Types$Noop = {ctor: 'Noop'};
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _mozilla$delivery_dashboard$View$spinner,
					_1: {ctor: '[]'}
				}),
			_1: {ctor: '[]'}
		});
...
if (typeof _mozilla$delivery_dashboard$Main$main !== 'undefined') {
    _mozilla$delivery_dashboard$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Types.Msg":{"args":[],"tags":{"Noop":[]}}},"aliases":{},"message":"Types.Msg"},"versions":{"elm":"0.18.0"}});
}
